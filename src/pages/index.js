                ...
                {destinations?.map(
                  ({ id, arrival, departure, location, city, region }) => {
                    ...
                    const santaIsHere =
                      ...
                      !santaWasHere;
                    let iconUrl = "/images/image.png";
                    let iconRetinaUrl = "/images/image2.png";
                    let className = "";
                    if (santaIsHere) {
                      className = `${className} ${styles.iconSantaIsHere}`;
                      iconUrl = "/images/image.png";
                      iconRetinaUrl = "/images/image2.png";
                    }

                    if (santaWasHere) {
                      iconUrl = "/images/image3.png";
                      iconRetinaUrl = "/images/image4.png";
                    }
                    return (
                      <Marker
                        key={id}
